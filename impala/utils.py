...
def action_idx_to_action_batch(multi_actions, act_dim):
    true_action_batch = list()
    # print('multi_actions: ',multi_actions)
    for batch_i in range(len(multi_actions)):
        true_action = [action_idx_to_action(int(multi_actions[batch_i][idx]), act_dim) \
                        for idx in range(len(multi_actions[batch_i]))]
        true_action_batch.append(true_action)
    return true_action_batch
