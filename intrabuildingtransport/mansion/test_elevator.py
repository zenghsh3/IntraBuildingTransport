...
from intrabuildingtransport.mansion.utils import PersonType, MansionState, ElevatorState, ElevatorAction
...
class TestElevator(unittest.TestCase):
  ...
  def test_door_load_unload(self, mock_uniformgenerator):
    ...
    test_elevator._loaded_person = [list() for i in range(test_elevator._number_of_floors)]
    test_elevator._loaded_person[2].append(PersonType(6, 40, 1, 3, world.raw_time))
    test_elevator._loaded_person[4].append(PersonType(7, 35, 1, 5, world.raw_time))
    ...
    person_generators.uniform_generator.UniformPersonGenerator.generate_person = mock.Mock(return_value = (ret_person))
  ...
  def test_overload(self, mock_uniformgenerator):
    ...
    test_elevator._loaded_person = [list() for i in range(test_elevator._number_of_floors)]
    test_elevator._loaded_person[5].append(PersonType(6, 750, 1, 6, world.raw_time))
    test_elevator._loaded_person[7].append(PersonType(7, 750, 1, 8, world.raw_time))
  ...
  def test_stop_at_dispatch(self, mock_uniformgenerator):
    ...
    test_elevator._target_floors = [5]
    test_elevator._loaded_person = [list() for i in range(test_elevator._number_of_floors)]
    test_elevator._loaded_person[5].append(PersonType(0, 50, 1, 6, world.raw_time))
    ...
    # dispatch.append(ElevatorAction(-1, 0))
    for i in range(2):
      test_mansion.run_mansion(dispatch)  # the door is fully open, t = 4.5
    state = test_mansion.state
    self.assertAlmostEqual(state.ElevatorStates[0].DoorState, 1.0)
    ...
    for i in range(6):
      test_mansion.run_mansion(dispatch)  # finish time open lag and close the door
    state = test_mansion.state
  ...
  def test_dispatch_when_closing(self, mock_uniformgenerator):
    ...
    test_elevator._loaded_person = [list() for i in range(test_elevator._number_of_floors)]
    test_elevator._loaded_person[3].append(PersonType(6, 40, 1, 4, world.raw_time))
    test_elevator._loaded_person[4].append(PersonType(7, 40, 1, 5, world.raw_time))
    test_elevator._load_weight = 80
    ...
    test_mansion.run_mansion(dispatch)  # the door is closing, the door state = 0.5, t = 3.5
    ...
    test_mansion.run_mansion(dispatch)  # the door is open, door_state = 1.0, time = 4.0
    state = test_mansion.state
    self.assertAlmostEqual(state.ElevatorStates[0].DoorState, 1.0)
  ...
  def test_dispatch_invalid(self, mock_uniformgenerator):
    ...
    test_elevator._loaded_person = [list() for i in range(test_elevator._number_of_floors)]
    test_elevator._loaded_person[4].append(PersonType(6, 40, 1, 5, world.raw_time))
    test_elevator._loaded_person[7].append(PersonType(7, 40, 1, 8, world.raw_time))
    test_elevator._load_weight = 80
    ...
    test_mansion.run_mansion(dispatch)
    state = test_mansion.state
    self.assertAlmostEqual(state.ElevatorStates[0].Velocity, 2.0)   # ignore the invalid dispatch
  ...
  def test_no_dispatch(self, mock_uniformgenerator):
    ...
    test_elevator._loaded_person = [list() for i in range(test_elevator._number_of_floors)]
    test_elevator._loaded_person[2].append(PersonType(0, 40, 1, 3, world.raw_time))
